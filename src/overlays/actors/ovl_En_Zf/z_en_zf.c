...
s32 EnZf_CanAttack(PlayState* play, EnZf* this) {
    ...
    if (this->actor.params >= ENZF_TYPE_LIZALFOS_MINIBOSS_A) {             // miniboss
        if (player->stateFlags1 & (PLAYER_STATE1_HANGING | PLAYER_STATE1_CLIMB_JUMP_UP)) { // Hanging or climbing
            return false;
        } else {
            return true;
        }
                ...
                if (rotDiff <= 10000) {
                    ...
                    if (yawDiff > 16000) {
                        ...
                        func_80B483E4(this, play);
                               ...
                               (PLAYER_STATE1_HOSTILE_LOCK_ON | PLAYER_STATE1_HANGING | PLAYER_STATE1_CLIMB_JUMP_UP)) {
