 ...
 * - func_808350A4 sets player->heldActor->parent (= Hookshot parent) to NULL, to signal fired weapon.
 ...
 */
void ArmsHook_Action_Wait(ArmsHook* this, PlayState* play) {
    if (this->actor.parent == NULL) { // = Player has fired Hookshot (set in func_808350A4)
