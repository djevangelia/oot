...
void EnNutsball_Update(Actor* thisx, PlayState* play) {
    ...
    if (!(player->stateFlags1 & (PLAYER_STATE1_TALKING | PLAYER_STATE1_DEAD | PLAYER_STATE1_28 | PLAYER_STATE1_CUTSCENE)) ||
        (this->actionFunc == EnNutsball_WaitForObject)) {
