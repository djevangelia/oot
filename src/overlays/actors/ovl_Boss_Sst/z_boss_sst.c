...
void BossSst_HeadSetupIntro(BossSst* this, PlayState* play) {
    ...
    player->stateFlags1 |= PLAYER_STATE1_BONGO_PREINTRO; // Set before intro cutscene starts to prevent player input
...
void BossSst_HeadIntro(BossSst* this, PlayState* play) {
    ...
    if (this->timer == 0) {
        ...
        player->stateFlags1 &= ~PLAYER_STATE1_BONGO_PREINTRO;
